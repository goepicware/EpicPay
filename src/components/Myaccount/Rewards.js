...
import { GET_CUSTOMER_DETAILS, GET_REWARDSETTING_LIST, GET_PROMOTION_LIST } from "../../actions";
...
class Rewards extends Component {
  ...
  componentWillReceiveProps(PropsDt) {
    ...
    if(this.state.promotionlist !== PropsDt.promotionlist) {
        ...
        this.setState({ promotionlist: PropsDt.promotionlist, available_promo_count: availablePromoCount});
    }
  }
  ...
  rewardActLst(rewardsettingsData,membership_spent_amount) {
    const rewardsettingsHtml = rewardsettingsData.map(
      (rewardsettings, rwInt) => {
        //let msnCls = 'active';
        let msnCls = (parseFloat(membership_spent_amount) >= parseFloat(rewardsettings.reward_pointstoreach))?"active":"";
        return (
  ...
  rewardProLst(rewardsettingsData) {
    const rewardsettingsHtml = rewardsettingsData.map(
      (rewardsettings, rwInt) => {
        ...
        let proImg = (rewardsettings.reward_freeproduct_image != '') ? <img src={rewardsettings.reward_freeproduct_image} alt="Coin" /> : '';
        return (
          <li className={msnCls}>
  ...
  rewardsSettingList(customerData, rewardsettingsData) {
    ...
    if (Object.keys(rewardsettingsData).length > 0) {
      ...
      if (membership_max_amount) {
        if(parseFloat(membership_spent_amount) > parseFloat(membership_max_amount)) {
        ...
        <div className="overview-merge">
          <div className="overview">
            ...
            <div className="ovr-view-inner">
              ...
              <div className={(parseFloat(calcMemberPerc)==100)?"slide-frame2 active":"slide-frame2"}></div>
  ...
  render() {
    ...
    if (Object.keys(customerData).length > 0) {
      let availablePoints = (customerData.custmap_available_points != '' && customerData.custmap_available_points != null && customerData.custmap_available_points != undefined)?customerData.custmap_available_points:0;
      let remnPoints = 0;
      ...
      return (
        <div className="main-div">
          ...
          <div className="container">
            ...
            {(enableMembership == 'Yes')&&<div className="container">
