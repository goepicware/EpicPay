...
import { apiUrl, unquieID, baseUrl, headerconfig } from "../Settings/Config";
  ...
  componentWillReceiveProps(PropsDt) {
    if (this.state.customerData !== PropsDt.customerdetails) {
      ...
      if (Object.keys(PropsDt.customerdetails).length > 0) {
        points_settings =
          Object.keys(PropsDt.customerdetails.points_settings).length > 0
            ? PropsDt.customerdetails.points_settings
            : Array();
        ...
        axios
          ...
          .then((res) => {
            ...
            if (res.data.status === "ok") {
              this.setState({
                regcust_sucess: "Referal code shared successfully",
              });
              let $_this = this;
              setTimeout(function () {
            ...
            {this.state.share_flag == "share" ? (
                  ...
                  <div className="up-form refral-frm">
                    ...
                    <div className="up-frm-btn">
                      <a
                        ...
                        onClick={this.userReferal.bind(this, "cancel")}
                      >
                        Cancel
                      </a>
              ...
              <div className="sticky-single-btn">
                <a
                  href="#"
                  className="button "
                  onClick={this.userReferal.bind(this, "initial")}
                >
