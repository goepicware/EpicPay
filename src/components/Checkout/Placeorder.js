...
import { apiUrl, baseUrl, stripeReference } from "../Settings/Config";
import {
  hideLoaderLst 
...
class Placeorder extends Component {
  constructor(props) {
    ...
    if (
      ...
      axios.post(apiUrl + "wallettopup/topup", (postObject))
      .then((res) => {
      ...
      setTimeout(
        function () {
          this.setState({
            processingText: "Please check in myaccount, to get order details.",
          });
        }.bind(this),
        300
      );
