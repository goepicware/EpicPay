    ...
    if(Object.keys(planData).length > 0) {
      if(parseInt(planQty) > 0) {
        ...
        if(topupplanCreditsAmount > 0) {
            ...
            this.setState({plan_subtotal: planSubtotal, tax_percentage: planGst, plan_gst_amount: planGstAmount, plan_grandtotal: planGrandtotal, error_msg: ''});
