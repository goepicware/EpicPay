...
import { apiUrl, unquieID, stripeReference } from "../Settings/Config";
...
class Home extends Component {
    ...
    if(Object.keys(planData).length > 0) {
      if(parseInt(planQty) > 0) {
        ...
        if(topupplanCreditsAmount > 0) {
            ...
            planGstAmount = (parseFloat(planGst) / 100) * planSubtotal;
  ...
  componentWillReceiveProps(PropsDt) {
    if(this.state.customerData !== PropsDt.customerdetails) {
        ...
        this.setState({ customerData: PropsDt.customerdetails, tax_type: tax_type, tax_percentage: tax_percentage },
          function () {
            //this.loadPlanData();
          });
    }
  ...
  render() {
    if(Object.keys(this.state.customerData).length > 0) {
        ...
        <div className="main-div">
              ...
              <div className="cart-detail">
                ...
                <div className="cart-detail-body">
                  ...
                  <ul>
                    ...
                    {((parseFloat(planGst) > 0) && (parseFloat(planGstAmount) > 0)) && <li>
                      <span>GST ({planGst} %)</span>
                      <strong>
          ...
          <IonFooter collapse="fade">
            <div className="sticky-single-btn">
              <a href="#" className="button green-btn place-order-link"  onClick={this.trigerPlaceOrderValidation.bind(this)}>
                Place Order
              </a>
