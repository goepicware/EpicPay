...
class Header extends Component {
   ...
   goToNavPage(activepage, event) {
      ...
      if(activepage == 'Top Up' || activepage == 'PointsRedeem') {
        ...
        let actionfrom = (Object.keys(this.props.mainpagestate).length > 0) ? this.props.mainpagestate.actionfrom : '';
        //pageTxt = (actionfrom == 'rewards') ? 'rewards' : 'home';
        pageTxt = (actionfrom == 'rewards') ? 'rewards' : 'myaccount';
      } else if(activepage == 'History' || activepage == 'Tier Benefits' || activepage == 'T & C') {
        pageTxt = 'rewards';
              ...
              <div className="container">
                ...
                {(activepage === 'My Account')?<><div className="ha-lhs">
                  <Link to={"/home"} title="Home" > 
                    {(companyLogo != '')?<img className="dynmic-cmp-logo" src={companyLogo} />:<img src={logo} />}
                  </Link>
                </div></>:<><div className="ha-lhs-arrow">
                    {(activepage != 'Epic') && <a href="#" onClick={this.goToNavPage.bind(this,activepage)}>
                      <img src={back} />
                    </a>}
                </div>
                ...
                <div className="ha-rhs">
                  <ul>
                  {(activepage === 'My Account') && <li className="profile-user home-linkcls">
        ...
        <div className={"side-bar full-height side-bar-maincls"}>
            <div className="container">
              <div className="three-nav">
                <Link to={"/refpage/myaccount"} className="button rv-btn" title="Myaccount" >
                  {" "}
